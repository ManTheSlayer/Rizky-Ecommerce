...
if (isset($_POST['shopping-cart'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (mysqli_stmt_affected_rows($insert_cart) > 0) {
            ...
            echo "<script>alert('Gagal menambahkan produk ke keranjang!'); window.location.href = '../keranjang.php';</script>";
        }
    }
...
<body>
    ...
    <section class="produk">
        ...
        <div class="produk-item">
            ...
            WHERE kategori IN ('banner', 'idcard', 'kartunama', 'pinmug', 'printa3', 'stiker', 'stempel', 'plakat')");
