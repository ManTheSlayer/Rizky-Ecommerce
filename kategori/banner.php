...
if (isset($_POST['shopping-cart'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        echo "<script>alert('Produk sudah ada di keranjang!'); window.location.href = 'banner.php';</script>";
    } else {
        ...
        if (mysqli_stmt_affected_rows($insert_cart) > 0) {
            echo "<script>alert('Produk ditambahkan ke keranjang!'); window.location.href = 'banner.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan produk ke keranjang!'); window.location.href = 'banner.php';</script>";
        }
    }
...
<body>
    ...
    <section class="produk">
        <div class="container">
            <h1>PRODUK</h1>
            <h1>X-Banner, Y-Banner, Giant Banner </h1>
        </div>
        <div class="title">
            <h2>Banner</h2>
        </div>
            ...
            while ($row = mysqli_fetch_assoc($result)):
                ...
                <div class="produk-card">
                    ...
                    <form class="add-to-cart-form" method="post" action="">
                        <a href="../detail/banner-detail.php?id=<?= $row['id'] ?>" id="detail"><i
