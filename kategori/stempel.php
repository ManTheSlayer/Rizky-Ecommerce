...
if (isset($_POST['shopping-cart'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        echo "<script>alert('Produk sudah ada di keranjang!'); window.location.href = 'stempel.php';</script>";
    } else {
        ...
        if (mysqli_stmt_affected_rows($insert_cart) > 0) {
            echo "<script>alert('Produk ditambahkan ke keranjang!'); window.location.href = 'stempel.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan produk ke keranjang!'); window.location.href = 'stempel.php';</script>";
        }
    }
...
<body>
    ...
    <section class="produk">
        <div class="container">
            <h1>S T E M P E L </h1>
            <h1>Plastik - Polimer - Karet - Kayu</h1>
        </div>
        <div class="title">
            <h2>Stempel</h2>
        </div>
