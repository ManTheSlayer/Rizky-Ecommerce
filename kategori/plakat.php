...
if (isset($_POST['shopping-cart'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        echo "<script>alert('Produk sudah ada di keranjang!'); window.location.href = 'plakat.php';</script>";
    } else {
        ...
        if (mysqli_stmt_affected_rows($insert_cart) > 0) {
            echo "<script>alert('Produk ditambahkan ke keranjang!'); window.location.href = 'plakat.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan produk ke keranjang!'); window.location.href = 'plakat.php';</script>";
        }
    }
...
<body>
    ...
    <section class="produk">
        <div class="container">
            <h1>P L A K A T</h1>
            <h1>Kayu - Resin - Akrilik - Fiber - Logam</h1>
        </div>
        <div class="title">
            <h2>Plakat</h2>
        </div>
        <div class="produk-item">
            <?php
            include("../php/config.php");
            $result = mysqli_query($con, "SELECT * FROM produk WHERE kategori = 'plakat'");
