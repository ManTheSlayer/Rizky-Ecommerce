...
if (isset($_POST['shopping-cart'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        echo "<script>alert('Produk sudah ada di keranjang!'); window.location.href = 'idcard.php';</script>";
    } else {
        ...
        if (mysqli_stmt_affected_rows($insert_cart) > 0) {
            echo "<script>alert('Produk ditambahkan ke keranjang!'); window.location.href = 'idcard.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan produk ke keranjang!'); window.location.href = 'idcard.php';</script>";
        }
    }
...
<body>
    ...
    <section class="produk">
        ...
        <div class="produk-item">
            <?php
            include("../php/config.php");
            $result = mysqli_query($con, "SELECT * FROM produk WHERE kategori = 'idcard'");
                ...
                <div class="jelajah">
                    ...
                    <div class="tentang">
                        ...
                        <a href="kartunama.php"><i data-feather="chevron-right" width="16" height="16"></i>
                            Kartu Nama</a>
                        <a href="printa3+.php"><i data-feather="chevron-right" width="16" height="16"></i> Print A3</a>
                        <a href="idcard.php"><i data-feather="chevron-right" width="16" height="16"></i> ID Card
                        </a>
                        <a href="plakat.php"><i data-feather="chevron-right" width="16" height="16"></i>
                            Plakat</a>
                        <a href="banner.php"><i data-feather="chevron-right" width="16" height="16"></i> Pin & Mug</a>
                        <a href="stiker.php"><i data-feather="chevron-right" width="16" height="16"></i> Stempel
                        </a>
