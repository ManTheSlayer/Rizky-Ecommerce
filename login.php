...
<body>
  ...
  <section class="login" id="login">
    <h1>Rizky<span>Pratama</span></h1>
    <div class="container">
      <div class="bungkus">
        <div class="vektor">
          <img src="asset/img/login1.png" alt="">
        </div>
        <div class="box">
          <div class="form-box">
            <?php
            ...
            if (isset($_POST['submit'])) {
              ...
              if (is_array($row) && !empty($row)) {
                ...
                if (password_verify($password, $row['password'])) {
                  ...
                  $_SESSION['id_user'] = $row['id']; // Ubah variabel sesi menjadi id_user
              ...
              <form action="" method="post">
                ...
                <div class="link">
                  Tidak punya akun? <a href="signup.php">Daftar</a>
                </div>
              </form>
            </div>
          <?php } ?>
