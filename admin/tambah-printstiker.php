            ...
            <div class="box" style="width: 60rem;">
                <div class="form-box">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (isset($_FILES['gambar'])) {
                            ...
                            if ($check !== false) {
                                ...
                                <p>Maaf, ukuran file max-2MB.</p>
                                    ...
                                    echo "<a href='index.php?type=produk&category=print-stiker'><button class='btn-kembali'>Kembali</button></a>";
                                } else {
                        ...
                        ?>
                        <h2>Tambah Print Stiker</h2>
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="item-form" style="display: flex; flex-wrap: wrap; gap: 1rem;">
                                <input type="hidden" name="kategori" id="kategori" value="stiker" />
