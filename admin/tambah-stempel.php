      ...
      <div class="box" style="width: 60rem;">
        <div class="form-box">
          ...
          if (isset($_POST['submit'])) {
                  ...
                  if (in_array($imageFileType, ['jpg', 'jpeg', 'png'])) {
                    ...
                    if (move_uploaded_file($tmpName, $target_file)) {
                      ...
                      if (mysqli_stmt_execute($stmt)) {
                        ...
                        echo "<a href='index.php?type=produk&category=stempel'><button class='btn-kembali'>Kembali</button></a>";
                      } else {
                        echo "<div class='message-error'>
            ...
            ?>
            <h2>Tambah Stempel</h2>
            <form action="" method="post" enctype="multipart/form-data">
              <div class="item-form" style="display: flex; flex-wrap: wrap; gap: 1rem;">
                <input type="hidden" name="kategori" id="kategori" value="stempel" />
