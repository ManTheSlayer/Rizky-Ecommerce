...
<head>
    ...
    <title>Tambah Print Stiker</title>
    <!-- Fonts -->
            ...
            <div class="box" style="width: 60rem;">
                <div class="form-box">
                    ...
                    if (isset($_POST['submit'])) {
                                ...
                                <p>Maaf, ukuran file max-2MB.</p>
                                    ...
                                    if (in_array($imageFileType, ['jpg', 'jpeg', 'png'])) {
                                        ...
                                        if (move_uploaded_file($tmpName, $target_file)) {
                                            ...
                                            <p>Print Stiker Berhasil Ditambah!</p>
                                          </div><br>";
                                                echo "<a href='index.php?type=produk&category=print-a3'><button class='btn-kembali'>Kembali</button></a>";
                                            } else {
                                                echo "<div class='message-error'>
                        ...
                        ?>
                        <h2>Tambah Print A3+</h2>
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="item-form" style="display: flex; flex-wrap: wrap; gap: 1rem;">
                                <input type="hidden" name="kategori" id="kategori" value="printa3" />
