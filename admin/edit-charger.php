    ...
    if (mysqli_affected_rows($con) > 0) {
        echo "
            <script>
                ...
                document.location.href = 'index.php?type=produk&category=print-stiker';
            </script>
        ";
    } else {
        echo "
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="item-form" style="display: flex; flex-wrap: wrap; gap: 1rem;">
                            ...
                            <div class="form-input">
                                ...
                                <input type="text" name="nama" id="nama" value="<?php echo $charger['nama']; ?>"
                                    required>
                            </div>
                            <div class="form-input">
                                <label for="harga">Harga</label>
                                <input type="text" id="harga" name="harga" value="<?php echo $charger['harga']; ?>"
                                    required>
                            </div>
                            <div class="form-input">
                                <label for="stok">Stok</label>
                                <input type="text" name="stok" id="stok" value="<?php echo $charger['stok']; ?>"
                                    required>
                            </div>
                            <div class="form-input">
                                <label for="bahan">Bahan</label>
                                <input type="text" name="bahan" id="bahan" value="<?php echo $charger['bahan']; ?>"
                                    required>
                            </div>
                            <div class="form-input">
                                <label for="berat">Berat</label>
                                <input type="text" name="berat" id="berat" value="<?php echo $charger['berat']; ?>"
                                    required>
                            </div>
                            <div class="form-input">
                                <label for="model">Model</label>
                                <input type="text" name="model" id="model" value="<?php echo $charger['model']; ?>"
                                    required>
                            </div>
                            <div class="form-input">
                                ...
                                <textarea type="text" name="deskripsi" id="deskripsi"
                                    ...
                                    required><?php echo $charger['deskripsi']; ?></textarea>
                            </div>
                            <div class="form-input">
                        ...
                        <div class="button-submit">
                            ...
                            <a href="index.php?type=produk&category=print-stiker" class="btn-kembali"><button
