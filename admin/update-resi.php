        ...
        <div class="form-box">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="button-submit">
              <input type="submit" class="btn-tambah" name="submit" value="Konfirmasi" />
              <a href="index.php?type=pesanan"><button type="button" class="btn-kembali" style="width: 7rem">
                  Kembali
                </button></a>
            </div>
          </form>
