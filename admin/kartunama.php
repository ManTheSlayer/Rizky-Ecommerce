    ...
    <div class="produk">
        <div class="table">
            <div class="table-box">
                <div class="judul-box">
                    <h1>Kartu Nama</h1>
                    <a href="tambah-kartunama.php"><button class="btn-tambah">Tambah Kartu Nama</button></a>
                </div>
                <!-- Table -->
                <table>
                    <thead>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)):
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit-aksesoris.php?id=<?= $row['id'] ?>"><button
                                            class="btn-edit">Edit</button></a>
                                    <a href="hapus-aksesoris.php?id=<?= $row["id"] ?>"
