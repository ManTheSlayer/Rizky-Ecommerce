      ...
      <div class="box" style="width: 60rem;">
        <div class="form-box">
          ...
          if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['gambar'])) {
              ...
              if ($check !== false) {
                ...
                if ($ukuranFile > 2000000) {
                  ...
                  echo "<a href='index.php?type=produk&category=pin-mug'><button class='btn-kembali'>Kembali</button></a>";
                } else {
            ...
            ?>
            <h2>Tambah Pin & Mug</h2>
            <form action="" method="post" enctype="multipart/form-data">
              <div class="item-form" style="display: flex; flex-wrap: wrap; gap: 1rem;">
                <input type="hidden" name="kategori" id="kategori" value="pinmug" />
